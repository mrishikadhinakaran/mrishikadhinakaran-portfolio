        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-center h-screen px-6 lg:px-20 text-center lg:text-left overflow-hidden">
            ...
            <div className="flex flex-col items-center lg:items-start gap-2 z-10">
                <motion.p
                    ...
                    className="text-white text-3xl md:text-2xl"
                >
            ...
            <motion.img
                ...
                className="w-60 sm:w-100 md:w-110 lg:w-[30rem] mt-[2rem] rounded-full ml-[7.5rem] mb-6 lg:mb-0 hover:shadow-2xl hover:shadow-orange-500/50 transition-shadow duration-300"
