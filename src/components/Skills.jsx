...
const skills = [
    {
      name: 'MongoDB',
      icon: <DiMongodb className="text-3xl sm:text-5xl text-[#47A248]" />,
    },
    {
      name: 'Express',
      icon: <SiExpress className="text-3xl sm:text-5xl text-[#888888]" />,
    },
    {
      name: 'React',
      icon: <DiReact className="text-3xl sm:text-5xl text-[#61DAFB]" />,
    },
    {
      name: 'NodeJS',
      icon: <DiNodejs className="text-3xl sm:text-5xl text-[#3C873A]" />,
    },
    {
      name: 'Firebase',
      icon: <SiFirebase className="text-3xl sm:text-5xl text-[#FFCA28]" />,
    },
    {
      name: 'Appwrite',
      icon: <SiAppwrite className="text-3xl sm:text-5xl text-[#F02E65]" />,
    },
    {
      name: 'Clerk',
      icon: <SiClerk className="text-3xl sm:text-5xl text-[#6549D5]" />,
    },
    {
      name: 'C',
      icon: <SiC className="text-3xl sm:text-5xl text-[#A8B9CC]" />,
    },
    {
      name: 'C++',
      icon: <SiCplusplus className="text-3xl sm:text-5xl text-[#00599C]" />,
    },
    {
      name: 'Java',
      icon: <DiJava className="text-3xl sm:text-5xl text-[#ED8B00]" />,
    },
    {
      name: 'Python',
      icon: <DiPython className="text-3xl sm:text-5xl text-[#3776AB]" />,
    },
    {
      name: 'TypeScript',
      icon: <SiTypescript className="text-3xl sm:text-5xl text-[#3178C6]" />,
    },
    {
      name: 'NextJS',
      icon: <SiNextdotjs className="text-3xl sm:text-5xl text-white" />,
    },
    {
      name: 'Tailwind',
      icon: <SiTailwindcss className="text-3xl sm:text-5xl text-[#38BDF8]" />,
    },
    {
      name: 'SQL',
      icon: <BiData className="text-3xl sm:text-5xl text-[#00758F]" />,
    },
  ];
